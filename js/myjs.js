const questionsList = [
	{
        ...
        <input type="radio" id="non" value="non" name="choice"></div><br>`,
		number: 1
	},
	{
	...
	{
		text: 'Question 8 : Cette exhausted vous oblige-t-elle à vous reposer plus de la moitié de la journée ?',
		choices: `<div class="box"><label for="oui">Oui</label>
        <input type="radio" value="oui" id="oui" name="choice"></div><br>
        <div class="box"><label for="non">Non</label>
        <input type="radio" id="non" value="non" name="choice"></div><br>`,
	...
	{
		text: 'Question 9 : Avez-vous des difficultés importantes pour vous alimenter ou boire depuis plus de 24h ? ',
		choices: `<div class="box"><label for="oui">Oui</label>
        <input type="radio" value="oui" id="oui" name="choice"></div><br>
        <div class="box"><label for="non">Non</label>
        <input type="radio" id="non" value="non" name="choice"></div><br>`,
	...
	{
		text:
			'Question 10 : Avez-vous vu apparaître une gêne respiratoire ou une augmentation de votre gêne respiratoire habituelle ? ',
		choices: `<div class="box"><label for="oui">Oui</label>
        <input type="radio" value="oui" id="oui" name="choice"></div><br>
        <div class="box"><label for="non">Non</label>
        <input type="radio" id="non" value="non" name="choice"></div><br>`,
	...
	{
		text: 'Question 11 : Comment vous sentez-vous ? ',
		choices: `<div class="flex-radio">
		<div class="mini">
		<div class="box"><label for="exhausted">Fatigué</label>
		<input type="radio" value="fatigué" id="exhausted" name="choice"></div><br>
		</div>
		<div class="mini">
		<div class="box"><label for="bien">Bien</label>
		<input type="radio" id="bien" value="bien" name="choice"></div><br>
		</div>
	</div>
	<div class="flex-radio">
		<div class="mini">
		<div class="box"><label for="trop-exhausted">Trop fatigué</label>
		<input type="radio" value="trop-fatigué" id="trop-exhausted" name="choice"></div><br>
	</div>
		<div class="mini">
		<div class="box"><label for="moyen">Moyen</label>
		<input type="radio" id="moyen" value="moyen" name="choice"></div><br>
	</div>
	</div>`,
		number: 11
	},
	{
		text: `Question 12 : Quel est votre âge ?
	...
	{
		text: `Question 13 : Quel est votre taille ?
	...
	{
		text: `Question 14 : Quel est votre poids ?
        Afin de calculer l’indice de masse corporelle qui est un facteur influençant le risque de complications de l’infection.`,
	...
	{
		text: `Question 15 : Avez-vous de l’hypertension artérielle ? Ou avez-vous une maladie cardiaque ou vasculaire ? Ou prenez-vous un traitement à visée cardiologique ?`,
		choices: `<div class="box"><label for="oui">Oui</label>
        <input type="radio" value="oui" id="oui" name="choice"></div><br>
        <div class="box"><label for="non">Non</label>
        <input type="radio" id="non" value="non" name="choice"></div><br>
        <div class="box"><label for="sspas">Ne sait pas</label>
        <input type="radio" id="sspas" value="oui" name="choice" ></div>`,
		number: 15
	},
	{
		text: `Question 16 : Êtes-vous diabétique ?`,
		choices: `<div class="box"><label for="oui">Oui</label>
        <input type="radio" value="oui" id="oui" name="choice"></div><br>
        <div class="box"><label for="non">Non</label>
        <input type="radio" id="non" value="non" name="choice"></div><br>`,
	...
	{
		text: `Question 17 : Avez-vous ou avez-vous eu un cancer ?`,
		choices: `<div class="box"><label for="oui">Oui</label>
        <input type="radio" value="oui" id="oui" name="choice"></div><br>
        <div class="box"><label for="non">Non</label>
        <input type="radio" id="non" value="non" name="choice"></div><br>`,
	...
	{
		text: `Question 18 : Avez-vous une maladie respiratoire ? Ou êtes-vous suivi par un pneumologue ? ?
	...
	{
		text: `Question 19 : Avez-vous une insuffisance rénale chronique dialysée ?`,
		choices: `<div class="box"><label for="oui">Oui</label>
        <input type="radio" value="oui" id="oui" name="choice"></div><br>
        <div class="box"><label for="non">Non</label>
        <input type="radio" id="non" value="non" name="choice"></div><br>`,
	...
	{
		text: `Question 20 : Avez-vous une maladie chronique du foie ?`,
		choices: `<div class="box"><label for="oui">Oui</label>
        <input type="radio" value="oui" id="oui" name="choice"></div><br>
        <div class="box"><label for="non">Non</label>
        <input type="radio" id="non" value="non" name="choice"></div><br>`,
	...
	{
		text: `Question 21 : Êtes-vous enceinte ?`,
		choices: `<div class="box"><label for="oui">Oui</label>
        <input type="radio" value="oui" id="oui" name="choice"></div><br>
        <div class="box"><label for="non">Non</label>
        <input type="radio" id="non" value="non" name="choice"></div><br>
        <div class="box"><label for="sspas">Non applicable</label>
        <input type="radio" id="sspas" value="non" name="choice" ></div>`,
		number: 21
	},
	{
		text: `Question 22 : Avez-vous une maladie connue pour diminuer vos défenses immunitaires ?`,
		choices: `<div class="box"><label for="oui">Oui</label>
        <input type="radio" value="oui" id="oui" name="choice"></div><br>
        <div class="box"><label for="non">Non</label>
        <input type="radio" id="non" value="non" name="choice"></div><br>
	...
	{
		text: `Question 23 : Prenez-vous un traitement immunosuppresseur ?
